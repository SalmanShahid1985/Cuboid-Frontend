  ...
  <v-row>
    <v-col class="col-6">
      ...
      <div
        ...
        v-if="$v.discountModel.discount_name.$error"
      >
        <span v-if="$v.discountModel.discount_name.$error"
    ...
    <v-col class="col-6">
      ...
      <div
        class="invalid-feedback"
        v-if="$v.discountModel.discount_start_date.$error"
      >
        <span v-if="$v.discountModel.discount_start_date.$error"
    ...
    <v-col class="col-6">
      ...
      <div
        class="invalid-feedback"
        v-if="$v.discountModel.discount_end_date.$error"
      >
        <span v-if="$v.discountModel.discount_end_date.$error"
    ...
    <v-col class="col-3">
      <label class="regularFont login-font" style=""
        >Discount Type <small style="color: red">*</small></label
      >
    ...
    <v-col class="col-3">
      ...
      <div
        class="invalid-feedback"
        v-if="$v.discountModel.discount_value.$error"
      >
        <span v-if="$v.discountModel.discount_value.$error"
    ...
    <v-col class="col-6">
      ...
      >
      <div class="right-inner-addon input-container pb-0">
        <select v-model="discount_product_id" class="form-control login-field">
    ...
    <!-- <v-col class="col-6">
        <v-select 
          :clearable="true"
          v-model="discountModel.discount_machine_id"
          label="Machine"
          color="blue darken-3"
        ></v-select>
      </v-col> -->
    <v-col class="col-6">
      ...
      <div class="right-inner-addon input-container pb-0">
        <select
          v-model="discountModel.discount_canteen_id"
          class="form-control login-field"
        >
...
export default {
  ...
  mounted() {
    ...
    if (this.getdiscountById) {
      ...
      if (this.discountModel.discount_product_id) {
        this.discount_product_id = this.discountModel.discount_product_id._id;
      }

      this.discountModel.discount_canteen_id =
        this.discountModel.discount_canteen_id._id;
